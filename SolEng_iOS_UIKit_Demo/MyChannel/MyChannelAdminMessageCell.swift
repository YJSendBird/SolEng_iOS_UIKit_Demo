//
//  MyChannelAdminMessageCell.swift
...
public class MyChannelAdminMessageCell: SBUBaseMessageCell {
    ...
    // MARK: - Common
    public override func configure(message: SBDBaseMessage, position: MessagePosition, hideDateView: Bool, receiptState: SBUMessageReceiptState) {
        super.configure(message: message, position: .center, hideDateView: hideDateView, receiptState: .none)

        self.messageLabel.numberOfLines = 0
        self.messageLabel.textAlignment = .center
        self.messageLabel.text = ("USER_CUSTOM::ADMIN::" + message.message)
        self.layoutIfNeeded()
